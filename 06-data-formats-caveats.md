...
If you want to store your data in `*.csv` and expect that your data may contain commas in their values, you can avoid the problem discussed above by putting the values in quotes (""). This [example data file](http://files.figshare.com/1919741/species.csv) applies this rule so the actual data looks like:
...
1. Open the [species.csv](http://files.figshare.com/1919741/species.csv) file in Excel (or Calc in Libre Office).
