...
programs in the same way as CSV files. For more of a discussion on data formats see [the discussion page](http://www.datacarpentry.org/spreadsheet-ecology-lesson/discuss/).
